...
<form method="POST" action="">
  ...
  <option selected disabled>Click here to select menu</option>
...
<div class="mt-3">
  <input type="submit" name="submit" class="btn" onclick="doalert();" style="background-color: #cbf1f5;">
</div>
</form>
...
function doalert()
{
  alert("Your transaction is successfully Done!")
}
</script>
